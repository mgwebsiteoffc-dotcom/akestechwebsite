...
'services/shopify-store-setup' => [
    ...
    'related' => [
        ['title' => 'Custom Theme Development', 'copy' => 'When a configured theme is not enough', 'url' => url('services/custom-shopify-theme-development')],
        ['title' => 'Shopify Migration & Integrations', 'copy' => 'Moving an existing store to Shopify', 'url' => url('services/shopify-migration-integrations')],
        ['title' => 'CRO & Store Optimization', 'copy' => 'Improve conversion after launch', 'url' => url('services/shopify-cro-optimization')],
        ['title' => 'Performance Marketing', 'copy' => 'Drive qualified traffic to the new store', 'url' => url('services/performance-marketing')],
    ],
],

'services/custom-shopify-theme-development' => [
    'slug'  => 'custom-shopify-theme-development',
    'route' => 'services/custom-shopify-theme-development',
    'parentName'  => 'Shopify & Commerce',
    'parentRoute' => 'services/shopify-growth',
    ...
    'faqSlug' => 'custom-shopify-theme-development',
    'faqs' => [
    ...
    'related' => [
        ...
        ['title' => 'CRO & Store Optimization', 'copy' => 'Test and improve what converts', 'url' => url('services/shopify-cro-optimization')],
    ],
],
...
'services/custom-shopify-development' => [
    ...
    'related' => [
        ['title' => 'Custom Theme Development', 'copy' => 'Design and front-end build', 'url' => url('services/custom-shopify-theme-development')],
        ['title' => 'Shopify Migration & Integrations', 'copy' => 'Platform migration and system connections', 'url' => url('services/shopify-migration-integrations')],
...
'services/shopify-plus' => [
    ...
    'related' => [
        ['title' => 'Shopify Migration & Integrations', 'copy' => 'Replatforming and system connections', 'url' => url('services/shopify-migration-integrations')],
...
'services/shopify-migration-integrations' => [
    'slug'  => 'shopify-migration-integrations',
    'route' => 'services/shopify-migration-integrations',
    'parentName'  => 'Shopify & Commerce',
    'parentRoute' => 'services/shopify-growth',
    ...
    'faqSlug' => 'shopify-migration-integrations',
    'faqs' => [
...
'services/shopify-cro-optimization' => [
    'slug'  => 'shopify-cro-optimization',
    'route' => 'services/shopify-cro-optimization',
    'parentName'  => 'Shopify & Commerce',
    'parentRoute' => 'services/shopify-growth',
    ...
    'faqSlug' => 'shopify-cro-optimization',
    'faqs' => [
    ...
    'related' => [
        ...
        ['title' => 'Custom Theme Development', 'copy' => 'Rebuild pages that cannot be fixed with tests', 'url' => url('services/custom-shopify-theme-development')],
...
'services/retargeting-retention' => [
    ...
    'related' => [
        ...
        ['title' => 'Shopify CRO', 'copy' => 'Improve the store those flows point to', 'url' => url('services/shopify-cro-optimization')],
    ],
],
...
'services/cro-experimentation' => [
    ...
    'related' => [
        ['title' => 'Shopify CRO', 'copy' => 'Store-side conversion optimisation', 'url' => url('services/shopify-cro-optimization')],
